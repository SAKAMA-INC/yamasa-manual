...
```
index.html          — マニュアル一覧（トップページ、5つのマニュアルへのカードリンク）
...
touroku/index.html  — 新規ユーザー登録手順書（運営スタッフ向け：招待コード発行・登録・確認）
```
...
- トップページのカードは相対パス `./kakouba/`, `./shohin/`, `./chuhmon/`, `./shuppin/`, `./touroku/` でリンク
